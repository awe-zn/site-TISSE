  ...
  <section class="posts mb-awe-90 mt-5 alinhar min-h-600">
    ...
    <?php if ($the_query->have_posts()) : while ($the_query->have_posts()) : $the_query->the_post(); ?>
        <div data-aos="flip-down" data-aos-delay="200" class="border-bottom border-1 border-Neve-Extra-Dark pt-3">
          <span class="font-inter fz-14 text-Prata-2">
            por <a href="#" class="fw-bold text-Prata-2"><?php the_author(); ?></a> ,
            publicado em <span class="fw-bold"><?php echo get_the_date('d.M.Y'); ?></span>
          </span>
          <a href="<?php the_permalink(); ?>" class="my-3 text-Aco font-inter fz-21 fw-bold d-block"><?php the_title(); ?></a>
        </div>
    <?php endwhile;
    else : endif; ?>
