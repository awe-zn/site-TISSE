...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-Ui-Color-Primary">
            <div class="container py-3">
              <a class="navbar-brand" href="<?php echo home_url('/');?>"><img src="<?php echo get_template_directory_uri();?>/dist/image/REDE-TISSE.svg" alt=""></a>
              ...
              <div class="collapse navbar-collapse justify-content-end font-inter" id="navbarNav">
                ...
                <ul class="navbar-nav icones">
                  <li class="nav-item icon">
                    <a class="nav-link text-uppercase fz-14 text-neve" href="#"><img src="<?php echo get_template_directory_uri();?>/dist/image/icon/twitter.svg" alt=""></a>
                  </li>
                  <li class="nav-item icon">
                    <a class="nav-link text-uppercase fz-14 text-neve" href="#"><img src="<?php echo get_template_directory_uri();?>/dist/image/icon/instagram.svg" alt=""></a>
                  </li>
                </ul>
              </div>
            </div>
