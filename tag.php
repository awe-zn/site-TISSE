...
<main class="container quem-somos">
        <nav style="--bs-breadcrumb-divider: '>>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item d-sm-block d-none font-inter fw-normal text-Prata-2 active" aria-current="page">Tags</li>
            </ol>
        </nav>
        <div data-aos="fade-down" data-aos-delay="200" class="title-page">
            <h1 class="font-inter fw-normal fz-44 py-4 m-0 text-break">
                            Filtragem de tags por <span class ="fw-bold"> “<?php single_cat_title ( '' , true );?>” </span>
                            </h1>
        </div>
        ...
        <section class="posts mb-awe-90 mt-5 alinhar">
          <div class="border-bottom border-1 border-Neve-Extra-Dark">
            <h5 class="font-inter fw-light text-Gray fz-26 my-3 ">Últimos posts da tag <span class ="fw-bold">“<?php single_tag_title ( '' , true );?>”</span></h5>
          </div>
          <?php
                       $args3 = array (
